    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">products whit critical expiration date</h3>
          ...
          <!-- Modal -->
              ...
              $dStart = new DateTime($Exp_date);
                ...
                <tr>
                  ...
                  <td bgcolor="#FF8080">  {{  $product->exp_date  }}     </td>
                  ...
                  <td>  <img src="http://127.0.0.1:8000/storage/images/{{$product->image}}" style="height:20px; width:20px;">   </td>
