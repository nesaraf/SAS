...
<form method="post" id="invoice_form" method="post">
...
<input type="submit" name="create_invoice" id="create_invoice" class="btn btn-info" value="Create" />
  ...
  @section('footersection')
          ...
          $('#total_item').val(count);
            ...
            var barcode = $('#item_barcod10').val();
              ...
              var barcode = $('#item_barcod20').val();
               ...
               $(document).on('click', '#create_invoice', function(event){
                   
                 console.log(count);

                   });

         // $(document).on('click','#crate_invoice',function(){
         //                 for (i =1; i <= count; i++) { 
         //                  var barcode = $('#item_barcod'+i).val();

         //                   $.ajax({
         //                type: 'POST',
         //                url:'/ajx/',
         //                data:{'_token':'{{ csrf_token()}} ',
         //                'amount': $('#order_item_quantity'+i).val(),
         //                'barcod':$('#item_barcod'+i)
         //                 },
         //                success:function(data){
         //                    // $("#item_name20").html(data[2]);
         //                    const pr = data;
   ...
   function updateAmountRemoveItemFromBill(){
